    ...
    <div class="p-6">
        <form action="{{ route('admin.social-media.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="url" name="link" id="link" value="{{ old('link') }}" placeholder="https://" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required>
